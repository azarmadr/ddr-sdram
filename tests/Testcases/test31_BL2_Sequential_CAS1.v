...
///////////////////////////////////////////////////////////////////////////////
//-----------------------------------------------------------------------------
//    Name    : test31_BL2_Sequential_CAS1.v
//    Author(): Udaykumar.R
//
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!*/
  ...
  begin
$display("\t\t+------------------------------+\n\t\t| test31_BL2_Sequential_CAS1.v |\n\t\t+------------------------------+");


// lodading the Mode Register with Burst length = 2, Rt =0, CAS Latency = 1
initialize_sdr_ddr(12'h011,1'b1); // sel = 1 for sdram
...
sdram_write(23'h700_600,REQLEN3);
wait(sdc_req_ack2);
sdram_read(23'h700_600,REQLEN3);
wait(sdc_req_ack2);

// Bank Address = 3,Row Address = 6 and Column Address = 1
sdram_write(23'h700_601,REQLEN0);
wait(sdc_req_ack2);
sdram_read(23'h700_601,REQLEN0);
