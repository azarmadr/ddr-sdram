...
///////////////////////////////////////////////////////////////////////////////
//-----------------------------------------------------------------------------
//    Name    : test28_BL8_Interleaved_CAS2.v
//    Author(): Udaykumar.R
//
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!*/
  ...
  begin
$display("\t\t+--------------------------------+\n\t\t| test28_BL8_Interleaved_CAS2.v  |\n\t\t+--------------------------------+");


// lodading the Mode Register with Burst length = 8, Rt =1, CAS Latency = 2
initialize_sdr_ddr(12'h02B,1'b1); // sel = 1 for sdram
