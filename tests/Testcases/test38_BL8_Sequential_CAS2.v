...
///////////////////////////////////////////////////////////////////////////////
//-----------------------------------------------------------------------------
//    Name    : test38_BL8_Sequential_CAS2.v
//    Author(): Udaykumar.R
//
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!*/
  ...
  begin
$display("\t\t+------------------------------+\n\t\t| test38_BL8_Sequential_CAS2.v |\n\t\t+------------------------------+");


// lodading the Mode Register with Burst length = 8, Rt =0, CAS Latency = 2
initialize_sdr_ddr(12'h023,1'b1); // sel = 1 for sdram
...
wait(sdc_req_ack2);
// Bank Address = 0,Row Address = 6 and Column Address = 1
sdram_write(23'h000_601,REQLEN0);
wait(sdc_req_ack2);
sdram_read(23'h000_601,REQLEN0);

wait(sdc_req_ack2);
// Bank Address = 0,Row Address = 6 and Column Address = 2
sdram_write(23'h000_602,REQLEN1);
wait(sdc_req_ack2);
sdram_read(23'h000_602,REQLEN1);

wait(sdc_req_ack2);
// Bank Address = 0,Row Address = 6 and Column Address = 3
sdram_write(23'h000_603,REQLEN0);
wait(sdc_req_ack2);
sdram_read(23'h000_603,REQLEN0);

wait(sdc_req_ack2);
// Bank Address = 0,Row Address = 6 and Column Address = 4
sdram_write(23'h000_604,REQLEN1);
wait(sdc_req_ack2);
sdram_read(23'h000_604,REQLEN1);

wait(sdc_req_ack2);
// Bank Address = 0,Row Address = 6 and Column Address = 5
sdram_write(23'h000_605,REQLEN0);
wait(sdc_req_ack2);
sdram_read(23'h000_605,REQLEN0);

wait(sdc_req_ack2);
// Bank Address = 0,Row Address = 6 and Column Address = 6
sdram_write(23'h000_606,REQLEN1);
wait(sdc_req_ack2);
sdram_read(23'h000_606,REQLEN1);

wait(sdc_req_ack2);
// Bank Address = 0,Row Address = 6 and Column Address = 7
sdram_write(23'h000_607,REQLEN0);
wait(sdc_req_ack2);
sdram_read(23'h000_607,REQLEN0);
