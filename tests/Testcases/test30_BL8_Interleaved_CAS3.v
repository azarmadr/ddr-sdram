...
///////////////////////////////////////////////////////////////////////////////
//-----------------------------------------------------------------------------
//    Name    : test30_BL8_Interleaved_CAS3.v
//    Author(): Udaykumar.R
//
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!*/
  ...
  begin
$display("\t\t+--------------------------------+\n\t\t| test30_BL8_Interleaved_CAS3.v |\n\t\t+-------------------------------+");


// lodading the Mode Register with Burst length = 8, Rt =1, CAS Latency = 3
initialize_sdr_ddr(12'h03B,1'b1); // sel = 1 for sdram
