...
///////////////////////////////////////////////////////////////////////////////
//-----------------------------------------------------------------------------
//    Name    : test27_BL4_Interleaved_CAS1.v
//    Author(): Udaykumar.R
//
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!*/
  ...
  begin
$display("\t\t+---------------------------------+\n\t\t| test27_BL4_Interleaved_CAS1.v  |\n\t\t+---------------------------------+");


// lodading the Mode Register with Burst length = 4, Rt =1, CAS Latency = 1
initialize_sdr_ddr(12'h01A,1'b1); // sel = 1 for sdram
...
sdram_write(23'ha00_600,REQLEN3);
wait(sdc_req_ack2);
sdram_read(23'ha00_600,REQLEN3);

wait(sdc_req_ack2);
// Bank Address = 1,Row Address = 6 and Column Address = 1
sdram_write(23'ha00_601,REQLEN3);
wait(sdc_req_ack2);
sdram_read(23'ha00_601,REQLEN3);

wait(sdc_req_ack2);
// Bank Address = 1,Row Address = 6 and Column Address = 2
sdram_write(23'ha00_602,REQLEN3);
wait(sdc_req_ack2);
sdram_read(23'ha00_602,REQLEN3);

wait(sdc_req_ack2);
// Bank Address = 1,Row Address = 6 and Column Address = 3
sdram_write(23'ha00_603,REQLEN3);
wait(sdc_req_ack2);
sdram_read(23'ha00_603,REQLEN3);
