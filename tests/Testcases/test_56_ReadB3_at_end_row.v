...
///////////////////////////////////////////////////////////////////////////////
//-----------------------------------------------------------------------------
//    Name    : test_56_ReadB3_at_end_row.v
//    Author(): Udaykumar.R
//
//    Description:   Load the MODE register and Read 1 Beat to bank3,at the 
...
// WRITE BANK 3 OF SDRAM

// Bank Address =3 ,Row Address = 6 and Column Address = 0
sdram_write(ADDRESS3XS,REQLEN3);
wait(sdc_req_ack2);

// Bank Address =3 ,Row Address = 6 and Column Address = 0
sdram_write(ADDRESS3XS,REQLEN2);
wait(sdc_req_ack2);

// Bank Address =3 ,Row Address = 6 and Column Address = 0
sdram_write(ADDRESS3XS,REQLEN1);
wait(sdc_req_ack2);

// Bank Address =3 ,Row Address = 6 and Column Address = 0
sdram_write(ADDRESS3XS,REQLEN0); 
wait(sdc_req_ack2);


// READ BANK 3 OF SDRAM

// Bank Address =3 ,Row Address = 6 and Column Address = 0
sdram_read(ADDRESS3XS,REQLEN3);
wait(sdc_req_ack2);

// Bank Address =3 ,Row Address = 6 and Column Address = 0
sdram_read(ADDRESS3XS,REQLEN2);
wait(sdc_req_ack2);

// Bank Address =3 ,Row Address = 6 and Column Address = 0
sdram_read(ADDRESS3XS,REQLEN1);
wait(sdc_req_ack2);

// Bank Address =3 ,Row Address = 6 and Column Address = 0
sdram_read(ADDRESS3XS,REQLEN0);
wait(sdc_req_ack2);
