...
///////////////////////////////////////////////////////////////////////////////
//-----------------------------------------------------------------------------
//    Name    : test_54_ReadB1_at_end_row.v
//    Author(): Udaykumar.R
//
...
// Bank Address =1 ,Row Address = 6 and Column Address = 0
sdram_read(ADDRESS1XS,REQLEN3);
wait(sdc_req_ack2);

// Bank Address =1 ,Row Address = 6 and Column Address = 0
sdram_read(ADDRESS1XS,REQLEN2);
wait(sdc_req_ack2);

// Bank Address =1 ,Row Address = 6 and Column Address = 0
sdram_read(ADDRESS1XS,REQLEN1);
wait(sdc_req_ack2);

// Bank Address =1 ,Row Address = 6 and Column Address = 0
sdram_read(ADDRESS1XS,REQLEN0); 
wait(sdc_req_ack2);
