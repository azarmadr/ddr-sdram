...
///////////////////////////////////////////////////////////////////////////////
//-----------------------------------------------------------------------------
//    Name    : test35_BL4_Sequential_CAS2.v
//    Author(): Udaykumar.R
//
...
sdram_write(23'h200_600,REQLEN3);
wait(sdc_req_ack2);
sdram_read(23'h200_600,REQLEN3);

wait(sdc_req_ack2);
// Bank Address = 1,Row Address = 6 and Column Address = 1
sdram_write(23'h200_601,REQLEN3);
wait(sdc_req_ack2);
sdram_read(23'h200_601,REQLEN3);

wait(sdc_req_ack2);
// Bank Address = 1,Row Address = 6 and Column Address = 2
sdram_write(23'h200_602,REQLEN3);
wait(sdc_req_ack2);
sdram_read(23'h200_602,REQLEN3);
