...
///////////////////////////////////////////////////////////////////////////////
//-----------------------------------------------------------------------------
//    Name    : test_62_R_spill_overB1_toBNext.v 
//    Author(): Udaykumar.R
//
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!*/
   ...
   begin
$display("\t\t+---------------------------------+\n\t\t|test_62_R_spill_overB1_toBNext.v|\n\t\t+---------------------------------+");
...
sdram_write(23'h3FFFFA,REQLEN3);
//wait(sdc_req_ack2);

sdram_write(23'h3FFFFB,REQLEN2);
//wait(sdc_req_ack2);

sdram_write(23'h3FFFFC,REQLEN1);
//wait(sdc_req_ack2);

sdram_write(23'h3FFFFD,REQLEN0);
wait(sdc_req_ack2);

// Read 1 Beat From the Bank0 

// Bank Address =0 ,Row Address = 6 and Column Address = 0
sdram_read(23'h3FFFFA,REQLEN3);
wait(sdc_req_ack2);

// Bank Address =0 ,Row Address = 6 and Column Address = 0
sdram_read(23'h3FFFFB,REQLEN2);
wait(sdc_req_ack2);

// Bank Address =0 ,Row Address = 6 and Column Address = 0
sdram_read(23'h3FFFFC,REQLEN1);
wait(sdc_req_ack2);

// Bank Address =0 ,Row Address = 6 and Column Address = 0
sdram_read(23'h3FFFFD,REQLEN0);
//wait(sdc_req_ack2);
