...
///////////////////////////////////////////////////////////////////////////////
//-----------------------------------------------------------------------------
//    Name    : test32_BL2_Sequential_CAS2.v
//    Author(): Udaykumar.R
//
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!*/
  ...
  begin
$display("\t\t+------------------------------+\n\t\t| test32_BL2_Sequential_CAS2.v |\n\t\t+------------------------------+");


// lodading the Mode Register with Burst length = 2, Rt =0, CAS Latency = 2
initialize_sdr_ddr(12'h021,1'b1); // sel = 1 for sdram
...
sdram_write(23'h500_600,REQLEN3);
wait(sdc_req_ack2);
sdram_read(23'h500_600,REQLEN3);

wait(sdc_req_ack2);
// Bank Address = 2,Row Address = 6 and Column Address = 1
sdram_write(23'h500_601,REQLEN2);
wait(sdc_req_ack2);
sdram_read(23'h500_601,REQLEN2);
