...
///////////////////////////////////////////////////////////////////////////////
//-----------------------------------------------------------------------------
//    Name    : test22_BL2_Interleaved_CAS1.v
//    Author(): Udaykumar.R
//
//    Description:   Load the MODE  register Burst length bits with 2 and starting 
//                   Column Address bit with 0/1 and Burst Type bit to 1 and Write 
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!*/
  ...
  begin
$display("\t\t+------------------------------+\n\t\t| test22_BL2_Interleaved_CAS1.v |\n\t\t+----------------------------+");


// lodading the Mode Register with Burst length = 2, Rt =1, CAS Latency = 1
initialize_sdr_ddr(12'h019,1'b1); // sel = 1 for sdram
