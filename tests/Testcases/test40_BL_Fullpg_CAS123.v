...
///////////////////////////////////////////////////////////////////////////////
//-----------------------------------------------------------------------------
//    Name    : test40_BL_Fullpg_CAS123.v
//    Author(): Udaykumar.R
//
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!*/
  ...
  begin
$display("\t\t+------------------------------+\n\t\t| test40_BL_Fullpg_CAS123.v |\n\t\t+------------------------------+");


// loading the Mode Register with Burst length = full Page, Rt =0, CAS Latency = 3
initialize_sdr_ddr(12'h037,1'b1); // sel = 1 for sdram
