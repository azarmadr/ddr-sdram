...
///////////////////////////////////////////////////////////////////////////////
//-----------------------------------------------------------------------------
//    Name    : test_53_ReadB0_at_end_row.v
//    Author(): Udaykumar.R
//
//    Description:   Load the MODE register and Read 1 Beat to bank0,at the 
...
*/
// WRITE TO THE BANK 0 OF SDRAM

// Bank Address =0 ,Row Address = 6 and Column Address = 0
sdram_write(ADDRESS0XS,REQLEN3);
wait(sdc_req_ack2);

// Bank Address =0 ,Row Address = 6 and Column Address = 0
sdram_write(ADDRESS0XS,REQLEN2);
wait(sdc_req_ack2);

// Bank Address =0 ,Row Address = 6 and Column Address = 0
sdram_write(ADDRESS0XS,REQLEN1);
wait(sdc_req_ack2);

// Bank Address =0 ,Row Address = 6 and Column Address = 0
sdram_write(ADDRESS0XS,REQLEN0); 
wait(sdc_req_ack2);

// READ TO THE BANK 0 OF SDRAM

// Bank Address =0 ,Row Address = 6 and Column Address = 0
sdram_read(ADDRESS0XS,REQLEN3);
wait(sdc_req_ack2);

// Bank Address =0 ,Row Address = 6 and Column Address = 0
sdram_read(ADDRESS0XS,REQLEN2);
wait(sdc_req_ack2);

// Bank Address =0 ,Row Address = 6 and Column Address = 0
sdram_read(ADDRESS0XS,REQLEN1);
wait(sdc_req_ack2);

// Bank Address =0 ,Row Address = 6 and Column Address = 0
sdram_read(ADDRESS0XS,REQLEN0); 
wait(sdc_req_ack2);
