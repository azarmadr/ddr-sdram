...
//                   SDRAM and Read,Check if there are any gaps between bank reading.
...
sdram_writeDM(ADDRESS0,REQLEN2,4'b0000);

wait(sdc_req_ack2);
// Bank Address = 1,Row Address = 6 and Column Address = 0
sdram_writeDM(ADDRESS1,REQLEN0,4'b0000);

wait(sdc_req_ack2);
// Bank Address = 2,Row Address = 6 and Column Address = 0
sdram_writeDM(ADDRESS2,REQLEN0,4'b0000);

wait(sdc_req_ack2);
// Bank Address = 3,Row Address = 6 and Column Address = 0
sdram_writeDM(ADDRESS3,REQLEN0,4'b0000); 
...
// Bank Address = 0,Row Address = 6 and Column Address = 0
sdram_readDM(ADDRESS0,REQLEN2,4'b0000);

wait(sdc_req_ack2);
// Bank Address = 1,Row Address = 6 and Column Address = 0
sdram_readDM(ADDRESS1,REQLEN0,4'b0000);

wait(sdc_req_ack2);
// Bank Address = 2,Row Address = 6 and Column Address = 0
sdram_readDM(ADDRESS2,REQLEN0,4'b0000);

wait(sdc_req_ack2);
// Bank Address = 3,Row Address = 6 and Column Address = 0
sdram_readDM(ADDRESS3,REQLEN0,4'b0000);
