...
///////////////////////////////////////////////////////////////////////////////
//-----------------------------------------------------------------------------
//    Name    : test_55_ReadB2_at_end_row.v
//    Author(): Udaykumar.R
//
//    Description:   Load the MODE register and Read 1 Beat to bank2,at the 
...
// WRITE TO THE BANK 2 OF SDRAM

// Bank Address =2 ,Row Address = 6 and Column Address = 0
sdram_write(ADDRESS2XS,REQLEN3);
wait(sdc_req_ack2);

// Bank Address =2 ,Row Address = 6 and Column Address = 0
sdram_write(ADDRESS2XS,REQLEN2);
wait(sdc_req_ack2);

// Bank Address =2 ,Row Address = 6 and Column Address = 0
sdram_write(ADDRESS2XS,REQLEN1);
wait(sdc_req_ack2);

// Bank Address =2 ,Row Address = 6 and Column Address = 0
sdram_write(ADDRESS2XS,REQLEN0); 
wait(sdc_req_ack2);

// READ TO THE BANK 2 OF SDRAM

// Bank Address =2 ,Row Address = 6 and Column Address = 0
sdram_read(ADDRESS2XS,REQLEN3);
wait(sdc_req_ack2);

// Bank Address =2 ,Row Address = 6 and Column Address = 0
sdram_read(ADDRESS2XS,REQLEN2);
wait(sdc_req_ack2);

// Bank Address =2 ,Row Address = 6 and Column Address = 0
sdram_read(ADDRESS2XS,REQLEN1);
wait(sdc_req_ack2);

// Bank Address =2 ,Row Address = 6 and Column Address = 0
sdram_read(ADDRESS2XS,REQLEN0);
wait(sdc_req_ack2);
