...
///////////////////////////////////////////////////////////////////////////////
//-----------------------------------------------------------------------------
//    Name    : test_43Single_location_Access.v
//    Author(): Udaykumar.R
//
//    Description:   Read/Write Single Location
//                   
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!*/
  ...
  begin
$display("\t\t+----------------------------------+\n\t\t| test_43Single_location_Access.v |\n\t\t+----------------------------------+");

// For Sequential Mode
// lodading the Mode Register with Burst length = 8, Rt = 0, CAS Latency = 3 WB = Single location
initialize_sdr_ddr(12'h233,1'b1); // sel = 1 for sdram
...
sdram_write(23'h200_600,REQLEN2);
wait(sdc_req_ack2);
sdram_read(23'h200_600,REQLEN2);

wait(sdc_req_ack2);
// Bank Address = 1,Row Address = 6 and Column Address = 1
sdram_write(23'h200_601,REQLEN2);
wait(sdc_req_ack2);
sdram_read(23'h200_601,REQLEN2);

wait(sdc_req_ack2);
// Bank Address = 1,Row Address = 6 and Column Address = 2
sdram_write(23'h200_602,REQLEN2);
wait(sdc_req_ack2);
sdram_read(23'h200_602,REQLEN2);

wait(sdc_req_ack2);
// Bank Address = 1,Row Address = 6 and Column Address = 3
sdram_write(23'h200_603,REQLEN3);
wait(sdc_req_ack2);
sdram_read(23'h200_603,REQLEN3);
...
// For Interleave Mode
// lodading the Mode Register with Burst length = 8, Rt = 1, CAS Latency = 3 WB = Single location
initialize_sdr_ddr(12'h23b,1'b1); // sel = 1 for sdram
