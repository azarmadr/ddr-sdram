...
///////////////////////////////////////////////////////////////////////////////
//-----------------------------------------------------------------------------
//    Name    : test33_BL2_Sequential_CAS3.v
//    Author(): Udaykumar.R
//
...
sdram_write(23'h600_600,REQLEN0);
wait(sdc_req_ack2);
sdram_read(23'h600_600,REQLEN0);

wait(sdc_req_ack2);
// Bank Address = 3,Row Address = 6 and Column Address = 1
sdram_write(23'h600_601,REQLEN1);
wait(sdc_req_ack2);
sdram_read(23'h600_601,REQLEN1);
